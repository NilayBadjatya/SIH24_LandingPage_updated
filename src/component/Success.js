  ...
  return (
    <>
      <div className="top-portion">
        ...
        <img src="computer.png" alt="" className="computer" />
        <img src="globe.png" alt="" className="globe" />
        <img src="bulb.png" alt="" className="bulb" />
        <img src="scale.png" alt="" className="scale" />
        <img src="tube.png" alt="" className="tube" />
        <img src="chemistry.png" alt="" className="chemistry" />
        <img src="pencil.png" alt="" className="pencil" />
      ...
      <img src="books.png" alt="" className="extra_img2" />
      <img src="arrow.png" alt="" className="extra_img1" />
      <div class="container mt-5">
        <div class="row">
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="card_photo2.png" class="card-img-top" alt="..." />
              <div class="card-body">
                <h5 class="card-title">Students's Name</h5>
                <p class="card-text">
                  Some quick example text to build on the card title and make up
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="card_photo3.png" class="card-img-top" alt="..." />
              <div class="card-body">
                <h5 class="card-title">Students's Name</h5>
                <p class="card-text">
                  Some quick example text to build on the card title and make up
        ...
        <div className="container">
          <img src="planet.png" alt="" className="extra_img3" />
          <img src="shade.png" alt="" className="extra_img4" />
        </div>
        <div class="row">
          <div class="col-md-4 mb-4">
            <div class="card">
